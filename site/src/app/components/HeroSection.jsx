  ...
  return (
    <section>
      <div className='grid grid-cols-1 sm:grid-cols-12'>
        <div className='col-span-7 place-self-center text-center sm:text-left sm:pl-4 xl:pl-16'>
        ...
        <p className='flex text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl'>
            I'm a data enthusiast; cryptology lover; machine learning nerd. Currently working as an student software engineer at IBM
        </p>
				<div>
            ...
            <span className='block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2'>
              Download CV
				...
				<div className="col-span-5 place-self-center mt-4 lg:mt-0 pl-8">
